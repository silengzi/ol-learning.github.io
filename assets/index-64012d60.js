...
`;const Y=j=>(_t("data-v-596e7dff"),j=j(),wt(),j),Tt={id:"title"},Dt=Y(()=>F("div",{id:"map",class:"map"},null,-1)),Et=Y(()=>F("p",null,[st("Example of using an animated GIF as an icon. Animation is achieved using the "),F("a",{href:"https://themadcreator.github.io/gifler/",target:"_blank"},"Gifler"),st(" library.")],-1)),Lt=Y(()=>F("h5",{class:"source-heading"},"html",-1)),jt={class:"language-html"},Bt=Y(()=>F("h5",{class:"source-heading"},"css",-1)),Mt={class:"language-css"},Rt=Y(()=>F("h5",{class:"source-heading"},"js",-1)),Ut={class:"language-js"},Gt=Y(()=>F("h5",{class:"source-heading"},"package.json",-1)),Nt={class:"language-json"},qt={__name:"index",setup(j){return pt(()=>{const b=new lt({geometry:new ft([0,0])}),C=new ct({features:[b]}),T=new yt({source:C}),E=new xt({source:new Ft({layer:"stamen_toner"})}),k=new ut({layers:[E,T],target:document.getElementById("map"),view:new ht({center:[0,0],zoom:2})}),A="https://openlayers.org/en/latest/examples/data/globe.gif";gifler(A).frames(document.createElement("canvas"),function(r,s){b.getStyle()||b.setStyle(new It({image:new bt({img:r.canvas,opacity:.8})})),r.clearRect(0,0,s.width,s.height),r.drawImage(s.buffer,s.x,s.y),k.render()},!0),k.on("pointermove",function(r){const s=k.getEventPixel(r.originalEvent),_=k.hasFeatureAtPixel(s);k.getTarget().style.cursor=_?"pointer":""}),Prism.highlightAll()}),(b,C)=>(mt(),gt(vt,null,[F("h4",Tt,tt(et(kt)),1),Dt,Et,Lt,F("pre",null,[F("code",jt,tt("  "+et(St).trim()),1)]),Bt,F("pre",null,[F("code",Mt,tt("  "+et(At).trim()),1)]),Rt,F("pre",null,[F("code",Ut,tt("  "+et(Vt).trim()),1)]),Gt,F("pre",null,[F("code",Nt,tt("  "+et(Ct).trim()),1)])],64))}},ne=dt(qt,[["__scopeId","data-v-596e7dff"]]);export{ne as default};
