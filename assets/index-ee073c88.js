import{F as D,V as G}from"./Vector-dc05cca5.js";import{g as B,z as H,u as X,P as W,a as Y,M as N,S as q,V as Q,T as $}from"./Layer-227d2e40.js";import{_ as J,i as K,o as Z,c as ee,b as p,t as T,g as E,F as te,p as re,k as ne,d as O}from"./index-0efe29ff.js";import{L as oe}from"./LineString-72752817.js";import{T as ie}from"./Tile-69a5f37c.js";import{T as se}from"./TileImage-97dc110f.js";import{T as ae}from"./TileProperty-167ee2c2.js";import{g as R,r as L}from"./net-c50a1c19.js";import{V as le}from"./Vector-1db23811.js";import"./featureloader-41324978.js";import"./Style-f78957a3.js";import"./BaseTile-962ada93.js";import"./TileLayer-94aa49a8.js";import"./Layer-10451559.js";import"./UrlTile-27538029.js";import"./VectorLayer-cfa00b56.js";import"./hitdetect-d04d171e.js";import"./vector-841020ca.js";const ce={"image/png":!0,"image/jpeg":!0,"image/gif":!0,"image/webp":!0},ue={"application/vnd.mapbox-vector-tile":!0,"application/geo+json":!0};function pe(r,e){let i,n;for(let a=0;a<r.length;++a){const l=r[a];if(l.rel==="item"){if(l.type===e){i=l.href;break}(ce[l.type]||!n&&l.type.startsWith("image/"))&&(n=l.href)}}if(!i)if(n)i=n;else throw new Error('Could not find "item" link');return i}function de(r,e,i){let n,a;const l={};for(let u=0;u<r.length;++u){const o=r[u];if(l[o.type]=o.href,o.rel==="item"){if(o.type===e){n=o.href;break}ue[o.type]&&(a=o.href)}}if(!n&&i)for(let u=0;u<i.length;++u){const o=i[u];if(l[o]){n=l[o];break}}if(!n)if(a)n=a;else throw new Error('Could not find "item" link');return n}function V(r,e,i,n){let a=r.projection;if(!a&&(a=B(e.crs),!a))throw new Error(`Unsupported CRS: ${e.crs}`);const l=a.getAxisOrientation().substr(0,2)!=="en",u=e.tileMatrices,o={};for(let t=0;t<u.length;++t){const h=u[t];o[h.id]=h}const x={},s=[];if(n)for(let t=0;t<n.length;++t){const h=n[t],d=h.tileMatrix;s.push(d),x[d]=h}else for(let t=0;t<u.length;++t){const h=u[t].id;s.push(h)}const _=s.length,c=new Array(_),m=new Array(_),b=new Array(_),P=new Array(_),F=[-1/0,-1/0,1/0,1/0];for(let t=0;t<_;++t){const h=s[t],d=o[h],v=d.pointOfOrigin;l?c[t]=[v[1],v[0]]:c[t]=v,m[t]=d.cellSize,b[t]=[d.matrixWidth,d.matrixHeight],P[t]=[d.tileWidth,d.tileHeight];const f=x[h];if(f){const M=d.cellSize*d.tileWidth,w=c[t][0]+f.minTileCol*M,j=c[t][0]+(f.maxTileCol+1)*M,g=d.cellSize*d.tileHeight,k=d.cornerOfOrigin==="bottomLeft";let C,S;k?(C=c[t][1]+f.minTileRow*g,S=c[t][1]+(f.maxTileRow+1)*g):(C=c[t][1]-(f.maxTileRow+1)*g,S=c[t][1]-f.minTileRow*g),H(F,[w,C,j,S],F)}}const U=new ae({origins:c,resolutions:m,sizes:b,tileSizes:P,extent:n?F:void 0}),z=r.context,I=r.url;function A(t,h,d){if(!t)return;const v=s[t[0]],f=o[v],M=f.cornerOfOrigin==="bottomLeft",w={tileMatrix:v,tileCol:t[1],tileRow:M?-t[2]-1:t[2]};if(n){const g=x[f.id];if(w.tileCol<g.minTileCol||w.tileCol>g.maxTileCol||w.tileRow<g.minTileRow||w.tileRow>g.maxTileRow)return}Object.assign(w,z);const j=i.replace(/\{(\w+?)\}/g,function(g,k){return w[k]});return L(I,j)}return{grid:U,urlTemplate:i,urlFunction:A}}function he(r,e){const i=e.tileMatrixSetLimits;let n;if(e.dataType==="map")n=pe(e.links,r.mediaType);else if(e.dataType==="vector")n=de(e.links,r.mediaType,r.supportedMediaTypes);else throw new Error('Expected tileset data type to be "map" or "vector"');if(e.tileMatrixSet)return V(r,e.tileMatrixSet,n,i);const a=e.links.find(o=>o.rel==="http://www.opengis.net/def/rel/ogc/1.0/tiling-scheme");if(!a)throw new Error("Expected http://www.opengis.net/def/rel/ogc/1.0/tiling-scheme link or tileMatrixSet");const l=a.href,u=L(r.url,l);return R(u).then(function(o){return V(r,o,n,i)})}function me(r){return R(r.url).then(function(e){return he(r,e)})}class fe extends se{constructor(e){super({attributions:e.attributions,cacheSize:e.cacheSize,crossOrigin:e.crossOrigin,interpolate:e.interpolate,projection:e.projection,reprojectionErrorThreshold:e.reprojectionErrorThreshold,state:"loading",tileLoadFunction:e.tileLoadFunction,wrapX:e.wrapX!==void 0?e.wrapX:!0,transition:e.transition});const i={url:e.url,projection:this.getProjection(),mediaType:e.mediaType,context:e.context||null};me(i).then(this.handleTileSetInfo_.bind(this)).catch(this.handleError_.bind(this))}handleTileSetInfo_(e){this.tileGrid=e.grid,this.setTileUrlFunction(e.urlFunction,e.urlTemplate),this.setState("ready")}handleError_(e){X(e),this.setState("error")}}const ge=fe,_e="Custom Interactions",we=`
