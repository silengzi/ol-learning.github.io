...
`;const f=_=>(he("data-v-dd7e3c09"),_=_(),pe(),_),Ce={id:"title"},Pe=f(()=>l("div",{id:"map",class:"map"},null,-1)),Oe=f(()=>l("div",null,[l("label",null,[l("input",{type:"checkbox",id:"rotateWithView"}),me(" Rotate with view")])],-1)),Me=f(()=>l("p",null,"This example demonstrates how you can customize the overviewmap control using its supported options as well as defining custom CSS. You can also rotate the map using the shift key to see how the overview map reacts.",-1)),Le=f(()=>l("h5",{class:"source-heading"},"html",-1)),Ve={class:"language-html"},Se=f(()=>l("h5",{class:"source-heading"},"css",-1)),Ie={class:"language-css"},Re=f(()=>l("h5",{class:"source-heading"},"js",-1)),Te={class:"language-js"},Ne=f(()=>l("h5",{class:"source-heading"},"package.json",-1)),Ae={class:"language-json"},Be={__name:"index",setup(_){return le(()=>{const e=document.getElementById("rotateWithView"),t=new _e({className:"ol-overviewmap ol-custom-overviewmap",layers:[new T({source:new R({url:"https://{a-c}.tile.thunderforest.com/cycle/{z}/{x}/{y}.png?apikey=eec3b356356248ab93334fd724ccb404"})})],collapseLabel:"»",label:"«",collapsed:!1});e.addEventListener("change",function(){t.setRotateWithView(this.checked)}),new W({controls:ne().extend([t]),interactions:oe().extend([new ue]),layers:[new T({source:new R})],target:"map",view:new z({center:[5e5,6e6],zoom:7})}),Prism.highlightAll()}),(e,t)=>(re(),ce(de,null,[l("h4",Ce,w(b(we)),1),Pe,Oe,Me,Le,l("pre",null,[l("code",Ve,w("  "+b(be).trim()),1)]),Se,l("pre",null,[l("code",Ie,w("  "+b(xe).trim()),1)]),Re,l("pre",null,[l("code",Te,w("  "+b(Ee).trim()),1)]),Ne,l("pre",null,[l("code",Ae,w("  "+b(ye).trim()),1)])],64))}},Ze=ae(Be,[["__scopeId","data-v-dd7e3c09"]]);export{Ze as default};
