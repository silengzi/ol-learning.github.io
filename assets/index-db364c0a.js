...
`;const w=m=>(U("data-v-7f264001"),m=m(),X(),m),ie={id:"title"},re=H('<div id="map" class="map" data-v-7f264001></div><form data-v-7f264001><div class="form-group" data-v-7f264001><label for="distance" class="col-form-label pb-0" data-v-7f264001>Cluster distance</label><input id="distance" class="form-range" type="range" min="0" max="200" step="1" value="40" data-v-7f264001><small class="form-text text-muted" data-v-7f264001> The distance within which features will be clustered together. </small></div><div class="form-group" data-v-7f264001><label for="min-distance" class="col-form-label pb-0" data-v-7f264001>Minimum distance</label><input id="min-distance" class="form-range" type="range" min="0" max="200" step="1" value="20" data-v-7f264001><small class="form-text text-muted" data-v-7f264001> The minimum distance between clusters. Can&#39;t be larger than the configured distance. </small></div></form><p data-v-7f264001>This example shows how to do clustering on point features.</p><h5 class="source-heading" data-v-7f264001>html</h5>',4),oe={class:"language-html"},ce=w(()=>a("h5",{class:"source-heading"},"css",-1)),le={class:"language-css"},ue=w(()=>a("h5",{class:"source-heading"},"js",-1)),de={class:"language-js"},me=w(()=>a("h5",{class:"source-heading"},"package.json",-1)),fe={class:"language-json"},he={__name:"index",setup(m){return R(()=>{const e=document.getElementById("distance"),s=document.getElementById("min-distance"),t=2e4,i=new Array(t),n=45e5;for(let o=0;o<t;++o){const l=[2*n*Math.random()-n,2*n*Math.random()-n];i[o]=new b(new S(l))}const d=new C({features:i}),r=new Z({distance:parseInt(e.value,10),minDistance:parseInt(s.value,10),source:d}),c={},p=new I({source:r,style:function(o){const l=o.get("features").length;let u=c[l];return u||(u=new $({image:new q({radius:10,stroke:new J({color:"#fff"}),fill:new x({color:"#3399CC"})}),text:new K({text:l.toString(),fill:new x({color:"#fff"})})}),c[l]=u),u}}),y=new Q({source:new W}),g=new z({layers:[y,p],target:"map",view:new B({center:[0,0],zoom:2})});e.addEventListener("input",function(){r.setDistance(parseInt(e.value,10))}),s.addEventListener("input",function(){r.setMinDistance(parseInt(s.value,10))}),g.on("click",o=>{p.getFeatures(o.pixel).then(l=>{if(l.length){const u=l[0].get("features");if(u.length>1){const F=P(u.map(D=>D.getGeometry().getCoordinates()));g.getView().fit(F,{duration:1e3,padding:[50,50,50,50]})}}})}),Prism.highlightAll()}),(e,s)=>(A(),O(N,null,[a("h4",ie,f(h(ee)),1),re,a("pre",null,[a("code",oe,f("  "+h(te).trim()),1)]),ce,a("pre",null,[a("code",le,f("  "+h(se).trim()),1)]),ue,a("pre",null,[a("code",de,f("  "+h(ne).trim()),1)]),me,a("pre",null,[a("code",fe,f("  "+h(ae).trim()),1)])],64))}},Me=G(he,[["__scopeId","data-v-7f264001"]]);export{Me as default};
