<template>
  ...
  <p>Example of exporting a map as a PDF using the <a href="https://github.com/parallax/jsPDF">jsPDF</a> library.</p>
...
import "../../../assets/js/jspdf.umd.min"
        ...
        Array.prototype.forEach.call(
          ...
          function (canvas) {
            if (canvas.width > 0) {
              ...
              console.log(transform.match(/^matrix\(([^]*)\)$/))
