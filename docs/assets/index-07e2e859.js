...
`;const Q=r=>(Ne("data-v-33966c3e"),r=r(),qe(),r),xt={id:"title"},yt=ke('<div id="map" class="map" data-v-33966c3e></div><table class="controls" data-v-33966c3e><tr data-v-33966c3e><td data-v-33966c3e><label for="hue" data-v-33966c3e>hue</label></td><td data-v-33966c3e><input id="hue" type="range" min="-180" max="180" value="0" data-v-33966c3e></td><td data-v-33966c3e><span id="hueOut" data-v-33966c3e></span> ° </td></tr><tr data-v-33966c3e><td data-v-33966c3e><label for="chroma" data-v-33966c3e>chroma</label></td><td data-v-33966c3e><input id="chroma" type="range" min="0" max="100" value="100" data-v-33966c3e></td><td data-v-33966c3e><span id="chromaOut" data-v-33966c3e></span> %</td></tr><tr data-v-33966c3e><td data-v-33966c3e><label for="lightness" data-v-33966c3e>lightness</label></td><td data-v-33966c3e><input id="lightness" type="range" min="0" max="100" value="100" data-v-33966c3e></td><td data-v-33966c3e><span id="lightnessOut" data-v-33966c3e></span> %</td></tr></table><p data-v-33966c3e>A raster source allows arbitrary manipulation of pixel values. In this example, RGB values on the input tile source are adjusted in a pixel-wise operation before being rendered with a second raster source. The raster operation takes pixels in in RGB space, converts them to HCL color space, adjusts the values based on the controls above, and then converts them back to RGB space for rendering.</p><h5 class="source-heading" data-v-33966c3e>html</h5>',4),bt={class:"language-html"},wt=Q(()=>A("h5",{class:"source-heading"},"css",-1)),vt={class:"language-css"},It=Q(()=>A("h5",{class:"source-heading"},"js",-1)),Rt={class:"language-js"},Et=Q(()=>A("h5",{class:"source-heading"},"package.json",-1)),At={class:"language-json"},Lt={__name:"index",setup(r){return Te(()=>{const n=.13793103448275862,a=6/29,i=3*a*a,o=a*a*a,c=2*Math.PI;function h(l){const f=y(l[0]),p=y(l[1]),w=y(l[2]),x=g((.4124564*f+.3575761*p+.1804375*w)/.95047),E=g((.2126729*f+.7151522*p+.072175*w)/1),v=g((.0193339*f+.119192*p+.9503041*w)/1.08883),L=116*E-16,I=500*(x-E),M=200*(E-v),N=Math.sqrt(I*I+M*M);let D=Math.atan2(M,I);return D<0&&(D+=c),l[0]=D,l[1]=N,l[2]=L,l}function u(l){const f=l[0],p=l[1],w=l[2],x=Math.cos(f)*p,E=Math.sin(f)*p;let v=(w+16)/116,L=isNaN(x)?v:v+x/500,I=isNaN(E)?v:v-E/200;return v=1*b(v),L=.95047*b(L),I=1.08883*b(I),l[0]=d(3.2404542*L-1.5371385*v-.4985314*I),l[1]=d(-.969266*L+1.8760108*v+.041556*I),l[2]=d(.0556434*L-.2040259*v+1.0572252*I),l}function g(l){return l>o?Math.pow(l,1/3):l/i+n}function b(l){return l>a?l*l*l:i*(l-n)}function y(l){return(l/=255)<=.04045?l/12.92:Math.pow((l+.055)/1.055,2.4)}function d(l){return 255*(l<=.0031308?12.92*l:1.055*Math.pow(l,1/2.4)-.055)}const R=new dt({sources:[new Xe({layer:"stamen_watercolor"})],operation:function(l,f){const p=h(l[0]);let w=p[0]+Math.PI*f.hue/180;return w<0?w+=c:w>c&&(w-=c),p[0]=w,p[1]*=f.chroma/100,p[2]*=f.lightness/100,u(p)},lib:{rgb2hcl:h,hcl2rgb:u,rgb2xyz:y,lab2xyz:b,xyz2lab:g,xyz2rgb:d,Xn:.95047,Yn:1,Zn:1.08883,t0:n,t1:a,t2:i,t3:o,twoPi:c}}),m={};R.on("beforeoperations",function(l){const f=l.data;for(const p in m)f[p]=Number(m[p].value)}),new Se({layers:[new he({source:R})],target:"map",view:new Me({center:[0,25e5],zoom:2,maxZoom:18})}),["hue","chroma","lightness"].forEach(function(l){const f=document.getElementById(l),p=document.getElementById(l+"Out");f.addEventListener("input",function(){p.innerText=f.value,R.changed()}),p.innerText=f.value,m[l]=f}),Prism.highlightAll()}),(e,s)=>(Ce(),Oe(je,null,[A("h4",xt,j(k(gt)),1),yt,A("pre",null,[A("code",bt,j("  "+k(mt).trim()),1)]),wt,A("pre",null,[A("code",vt,j("  "+k(pt).trim()),1)]),It,A("pre",null,[A("code",Rt,j("  "+k(ft).trim()),1)]),Et,A("pre",null,[A("code",At,j("  "+k(_t).trim()),1)])],64))}},Bt=De(Lt,[["__scopeId","data-v-33966c3e"]]);export{Bt as default};
