...
`;const a=r=>(V("data-v-a45a0186"),r=r(),D(),r),X={id:"title"},Y=a(()=>n("div",{id:"map",class:"map"},null,-1)),B=a(()=>n("p",null,[_("This map has a view that is constrained in an extent. This is done using the "),n("code",null,"extent"),_(" view option. Please note that specifying "),n("code",null,"constrainOnlyCenter: true"),_(" would only apply the extent restriction to the view center.")],-1)),W=a(()=>n("h5",{class:"source-heading"},"html",-1)),U={class:"language-html"},J=a(()=>n("h5",{class:"source-heading"},"css",-1)),$={class:"language-css"},q=a(()=>n("h5",{class:"source-heading"},"js",-1)),G={class:"language-js"},Q=a(()=>n("h5",{class:"source-heading"},"package.json",-1)),tt={class:"language-json"},et={__name:"index",setup(r){return F(()=>{const t=new T({center:[328627.563458,5921296662223e-6],zoom:8,extent:[-572513.341856,5211017966314e-6,916327.095083,6636950728974e-6]});new C({layers:[new I({source:new O})],keyboardEventTarget:document,target:"map",view:t,controls:b().extend([new A])}),Prism.highlightAll()}),(t,e)=>(M(),x(N,null,[n("h4",X,d(h(j)),1),Y,B,W,n("pre",null,[n("code",U,d("  "+h(Z).trim()),1)]),J,n("pre",null,[n("code",$,d("  "+h(k).trim()),1)]),q,n("pre",null,[n("code",G,d("  "+h(K).trim()),1)]),Q,n("pre",null,[n("code",tt,d("  "+h(H).trim()),1)])],64))}},_t=P(et,[["__scopeId","data-v-a45a0186"]]);export{_t as default};
